...
def collect_data(simAnalysisData:simAnalysisData, sid, in_nodes, pnow, vnow, oxnow):
    data = [pnow[in_nodes[0]], np.average(vnow), np.average(oxnow)]
    simAnalysisData.pressure.append(data[0])
    simAnalysisData.vegf.append(data[1])
    simAnalysisData.oxygen.append(data[2])
