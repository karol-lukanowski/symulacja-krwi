...
def update_matrix(vresult, reg_reg_edges, reg_something_edges, other_edges, Dv):
...
def update_graph(vnow, oxresult, reg_reg_edges, reg_something_edges, in_edges, dt_ox, dth):
