...
def build(sid:simInputData):
    ...
    if sid.load == 0:
        G, boundary_edges = De.Build_delaunay_net(sid.n, noise = sid.noise)
        ...
        Sv.save_all('/template.dill', sid, G, edges, oxresult, in_nodes, out_nodes, in_nodes_ox, out_nodes_ox, boundary_edges)
